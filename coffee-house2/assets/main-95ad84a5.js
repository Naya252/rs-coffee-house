...
`);let t="";ue.forEach(e=>{t+=`<button id="${e.name.toLowerCase()}">
  ...
  `}),document.querySelector(".menu__items").insertAdjacentHTML("afterbegin",o)}function pe(){g(),fe(),f()}i===r?(console.log("main"),he()):(console.log("menu"),pe());
//# sourceMappingURL=main-95ad84a5.js.map
