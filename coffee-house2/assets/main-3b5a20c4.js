...
`,u=p,G=A,H=m,V=v,z=C,K=w,N=b,J=E,T=M,W=j,q=k,Y=I,D=P,Z=R,X=U,{BASE_URL:i}={BASE_URL:"https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/",MODE:"production",DEV:!1,PROD:!0,SSR:!1},r=window.location.pathname,_="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/logo-5f25b395.svg";const c=[{name:"logo",link:"enjoy",anchor:"enjoy"},{name:"Favorite coffee",link:"favorite-coffee"},{name:"About",link:"about"},{name:"Mobile app",link:"mobile-app"},{name:"Contact us",link:"footer"},{name:"Menu",link:`${i}menu/`}],d=c.slice(1,-1);function g(){let t;const o="#";r===`${i}menu/`?(t=`${i}#`,c[0].link=i):(t="#",c[0].link=`${i}#enjoy`);let e="";document.querySelector("body").insertAdjacentHTML("afterbegin",`
      ...
      <div class="enjoy__content">
        ...
        <div class="enjoy__content_offer-wrapper">
          <div class="enjoy__content_offer">
            ...
            <a class="button-primary enjoy-btn" href="${i}menu/"> <span>Menu</span> ${u} </a>
          </div>
        </div>
      </div>
    </section>
...
`)}console.log(d);console.log(r);console.log(i);function le(t){t.forEach(o=>{const e=o.target;o.isIntersecting?document.querySelectorAll(".nav-item").forEach(n=>{n.classList.toggle("active",n.getAttribute("id").replace("nav-","")===e.id)}):!o.isIntersecting&&r===`${i}`&&document.querySelectorAll(".nav-item").forEach(n=>{n.classList.remove("active")})})}const h=new IntersectionObserver(le,{threshold:[.5,1]});function de(){r===`${i}menu/`?(document.querySelector("#nav-menu").classList.add("active"),document.querySelector("#nav-menu").style.pointerEvents="none",["menu","footer"].forEach(t=>{h.observe(document.getElementById(t))})):d.forEach(t=>{h.observe(document.getElementById(t.link))})}function f(){document.querySelector("#main").insertAdjacentHTML("afterend",`
...
`);let t="";ue.forEach(e=>{t+=`<button id="${e.name.toLowerCase()}">
  ...
  `}),document.querySelector(".menu__items").insertAdjacentHTML("afterbegin",o)}function pe(){g(),fe(),f()}r.includes("menu")?(console.log("menu"),pe()):(console.log("main"),he());
//# sourceMappingURL=main-3b5a20c4.js.map
