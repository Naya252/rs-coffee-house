(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function e(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=e(s);fetch(s.href,a)}})();const p=`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,m=`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,b=`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,k=`<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,u=p,G=A,H=m,V=v,z=C,K=w,N=b,J=E,T=M,W=j,q=k,Y=I,D=P,Z=R,X=U,{BASE_URL:c}={BASE_URL:"https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/",MODE:"production",DEV:!1,PROD:!0,SSR:!1},r=window.location.pathname,_="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/logo-5f25b395.svg";const i=[{name:"logo",link:"enjoy",anchor:"enjoy"},{name:"Favorite coffee",link:"favorite-coffee"},{name:"About",link:"about"},{name:"Mobile app",link:"mobile-app"},{name:"Contact us",link:"footer"},{name:"Menu",link:`${c}menu/`}],h=i.slice(1,-1);function g(){let t;const o="#";r.includes("menu")?(t=`${c}#`,i[0].link=c):(t="#",i[0].link=`${c}#enjoy`);let e="";document.querySelector("body").insertAdjacentHTML("afterbegin",`
  ...
  `),h.forEach(n=>{e+=`
    <li>
          <a
          id="nav-${n.link}"
            href="${n.link==="footer"?o+n.link:t+n.link}"
            class="nav-item">${n.name}</a>
    </li>
    `}),document.querySelector("#nav-list").insertAdjacentHTML("afterbegin",e)}const $="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/img-hero-1fb4a687.svg",ee="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/video(2160p)-21ac9e89.mp4";function te(){document.querySelector("#header").insertAdjacentHTML("afterend",`
      ...
      <div class="enjoy__content">
        ...
        <div class="enjoy__content_offer-wrapper">
          <div class="enjoy__content_offer">
            ...
            <a class="button-primary enjoy-btn" href="${c}menu/"> <span>Menu</span> ${u} </a>
          </div>
        </div>
      </div>
    </section>
  </main>
  `)}function oe(){document.querySelector("#enjoy").insertAdjacentHTML("afterend",`
  <section id="favorite-coffee" class="section">
    ...
    <div class="slider">
      ...
      <div class="slider__buttons">
        <button class="slider__buttons_btn-left rounded-btn transparent-dark-btn">${J}</button>
        <button class="slider__buttons_btn-right rounded-btn transparent-dark-btn">${T}</button>
      </div>
  ...
  `)}const se="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/about-1-d836e95d.svg",ne="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/about-2-693e846d.svg",ae="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/about-3-667f0d6b.svg",ie="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/about-4-96517610.svg";function ce(){document.querySelector("#favorite-coffee").insertAdjacentHTML("afterend",`
  ...
  `)}function re(){document.querySelector("#about").insertAdjacentHTML("afterend",`
...
`)}function le(t){t.forEach(o=>{const e=o.target;o.isIntersecting?document.querySelectorAll(".nav-item").forEach(n=>{n.classList.toggle("active",n.getAttribute("id").replace("nav-","")===e.id)}):!o.isIntersecting&&r===`${c}`&&document.querySelectorAll(".nav-item").forEach(n=>{n.classList.remove("active")})})}const d=new IntersectionObserver(le,{threshold:[.5,1]});function de(){r.includes("menu")?(document.querySelector("#nav-menu").classList.add("active"),document.querySelector("#nav-menu").style.pointerEvents="none",["menu","footer"].forEach(t=>{d.observe(document.getElementById(t))})):h.forEach(t=>{d.observe(document.getElementById(t.link))})}function f(){document.querySelector("#main").insertAdjacentHTML("afterend",`
<footer id="footer" class="wrap mx-auto mt-auto mb-10">
  ...
  <div class="footer__contacts">
    ...
    <a
      ...
      ><span>${K} 8558 Green Rd., LA</span></a
    >
    <a
      class="link mb-1"
      href="tel:+16035550123"
      ><span>${z} +1 (603) 555-0123</span></a
    >
    <span class="link mb-1">${N} Mon-Sat: 9:00 AM – 23:00 PM</span>
  </div>
</footer>
`);const t=[G,H,V];let o="";t.forEach(e=>{o+=`<button class="social__btn rounded-btn transparent-light-btn">${e}</button>`}),document.querySelector("#socials").insertAdjacentHTML("afterbegin",o),de()}function ue(){g(),te(),oe(),ce(),re(),f()}const he=[{name:"Coffee",img:D},{name:"Tea",img:Z},{name:"Dessert",img:X}],ge=[{name:"Irish coffee",descriptions:"Fragrant black coffee with Jameson Irish whiskey and whipped milk",price:"$7.00",img:S},{name:"Kahlua coffee",descriptions:"Classic coffee with milk and Kahlua liqueur under a cap of frothed milk",price:"$7.00",img:Q},{name:"Honey raf",descriptions:"Espresso with frothed milk, cream and aromatic honey",price:"$5.50",img:x},{name:"Ice cappuccino",descriptions:"Cappuccino with soft thick foam in summer version with ice",price:"$5.00",img:B},{name:"Espresso",descriptions:"Classic black coffee",price:"$4.50",img:y},{name:"Latte",descriptions:"Espresso coffee with the addition of steamed milk and dense milk foam",price:"$5.50",img:L},{name:"Latte macchiato",descriptions:"Espresso with frothed milk and chocolate",price:"$5.50",img:F},{name:"Coffee with cognac",descriptions:"Fragrant black coffee with cognac and whipped cream",price:"$6.50",img:O}];function fe(){document.querySelector("#header").insertAdjacentHTML("afterend",`
<main id="main" class="wrap mx-auto mt-5">
  <section id="menu">
    ...
    <button id="more-cards" class="rounded-btn transparent-dark-btn">${Y}</button>
  </section>
</main>
`);let t="";he.forEach(e=>{t+=`<button id="${e.name.toLowerCase()}">
  <span class="button_img-container">${e.img}</span>
  <span class="button_text">${e.name}</span>
  </button>`}),document.querySelector(".menu__tabs").insertAdjacentHTML("afterbegin",t),document.querySelector("#coffee").classList.add("active");let o="";ge.forEach(e=>{o+=`
  <div class="card">
    <div class="card__img">
      <img
        src="${e.img}"
  ...
  `}),document.querySelector(".menu__items").insertAdjacentHTML("afterbegin",o)}function pe(){g(),fe(),f()}r.includes("menu")?pe():ue();
//# sourceMappingURL=main-9e65ae38.js.map
