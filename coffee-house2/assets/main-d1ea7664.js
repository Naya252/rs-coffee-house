...
</svg>`,I=`<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,S=`<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,x="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/coffee-1-ffdd7d23.svg",B="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/coffee-2-ec13b162.svg",y="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/coffee-3-b3754dc7.svg",L="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/coffee-4-5be7bdc8.svg",F="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/coffee-5-15f5ed2a.svg",O="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/coffee-6-191d055e.svg",P="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/coffee-7-8cbb8963.svg",R="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/coffee-8-3d8babb0.svg",U=`
...
`,g=m,V=v,z=C,K=w,N=b,J=E,T=M,W=j,q=k,Y=I,D=S,Z=Q,X=U,_=G,$=H,{BASE_URL:a}={BASE_URL:"https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/",MODE:"production",DEV:!1,PROD:!0,SSR:!1},r=window.location.pathname,ee="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/logo-5f25b395.svg";const c=[{name:"logo",link:"enjoy",anchor:"enjoy"},{name:"Favorite coffee",link:"favorite-coffee"},{name:"About",link:"about"},{name:"Mobile app",link:"mobile-app"},{name:"Contact us",link:"footer"},{name:"Menu",link:`${a}menu/`}];let d;const te="#";r===`${a}menu/`?(d=`${a}#`,c[0].link=a):(d="#",c[0].link=`${a}#enjoy`);const f=c.slice(1,-1);let h="";const oe=f;function p(){document.querySelector("body").insertAdjacentHTML("afterbegin",`
  ...
  `),f.forEach(e=>{h+=`
    <li>
          <a
          id="nav-${e.link}"
            href="${e.link==="footer"?te+e.link:d+e.link}"
            class="nav-item">${e.name}</a>
    </li>
    `}),document.querySelector("#nav-list").insertAdjacentHTML("afterbegin",h)}const se="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/img-hero-1fb4a687.svg",ne="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/video(2160p)-21ac9e89.mp4";function ae(){document.querySelector("#header").insertAdjacentHTML("afterend",`
      ...
      <div class="enjoy__content">
        ...
        <div class="enjoy__content_offer-wrapper">
          <div class="enjoy__content_offer">
            ...
            <a class="button-primary enjoy-btn" href="${a}menu/"> <span>Menu</span> ${g} </a>
          </div>
        </div>
      </div>
    </section>
  </main>
  `)}function ie(){document.querySelector("#enjoy").insertAdjacentHTML("afterend",`
  <section id="favorite-coffee" class="section">
    ...
    <div class="slider">
      ...
      <div class="slider__buttons">
        <button class="slider__buttons_btn-left rounded-btn transparent-dark-btn">${W}</button>
        <button class="slider__buttons_btn-right rounded-btn transparent-dark-btn">${q}</button>
      </div>
  ...
  `)}const ce="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/about-1-d836e95d.svg",re="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/about-2-693e846d.svg",le="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/about-3-667f0d6b.svg",de="https://rolling-scopes-school.github.io/naya252-JSFE2023Q4/coffee-house2/assets/about-4-96517610.svg";function he(){document.querySelector("#favorite-coffee").insertAdjacentHTML("afterend",`
  ...
  `)}function ue(){document.querySelector("#about").insertAdjacentHTML("afterend",`
...
`)}function ge(e){e.forEach(s=>{const t=s.target;s.isIntersecting?document.querySelectorAll(".nav-item").forEach(i=>{i.classList.toggle("active",i.getAttribute("id").replace("nav-","")===t.id)}):!s.isIntersecting&&r===`${a}`&&document.querySelectorAll(".nav-item").forEach(i=>{i.classList.remove("active")})})}const u=new IntersectionObserver(ge,{threshold:[.5,1]});function fe(){r===`${a}menu/`?(document.querySelector("#nav-menu").classList.add("active"),document.querySelector("#nav-menu").style.pointerEvents="none",["menu","footer"].forEach(e=>{u.observe(document.getElementById(e))})):oe.forEach(e=>{u.observe(document.getElementById(e.link))})}function A(){document.querySelector("#main").insertAdjacentHTML("afterend",`
<footer id="footer" class="wrap mx-auto mt-auto mb-10">
  ...
  <div class="footer__contacts">
    ...
    <a
      ...
      ><span>${J} 8558 Green Rd., LA</span></a
    >
    <a
      class="link mb-1"
      href="tel:+16035550123"
      ><span>${N} +1 (603) 555-0123</span></a
    >
    <span class="link mb-1">${T} Mon-Sat: 9:00 AM – 23:00 PM</span>
  </div>
</footer>
`);const e=[V,z,K];let s="";e.forEach(t=>{s+=`<button class="social__btn rounded-btn transparent-light-btn">${t}</button>`}),document.querySelector("#socials").insertAdjacentHTML("afterbegin",s),fe()}function pe(){p(),ae(),ie(),he(),ue(),A()}const Ae=[{name:"Coffee",img:X},{name:"Tea",img:_},{name:"Dessert",img:$}],me=[{name:"Irish coffee",descriptions:"Fragrant black coffee with Jameson Irish whiskey and whipped milk",price:"$7.00",img:x},{name:"Kahlua coffee",descriptions:"Classic coffee with milk and Kahlua liqueur under a cap of frothed milk",price:"$7.00",img:B},{name:"Honey raf",descriptions:"Espresso with frothed milk, cream and aromatic honey",price:"$5.50",img:y},{name:"Ice cappuccino",descriptions:"Cappuccino with soft thick foam in summer version with ice",price:"$5.00",img:L},{name:"Espresso",descriptions:"Classic black coffee",price:"$4.50",img:F},{name:"Latte",descriptions:"Espresso coffee with the addition of steamed milk and dense milk foam",price:"$5.50",img:O},{name:"Latte macchiato",descriptions:"Espresso with frothed milk and chocolate",price:"$5.50",img:P},{name:"Coffee with cognac",descriptions:"Fragrant black coffee with cognac and whipped cream",price:"$6.50",img:R}];function ve(){document.querySelector("#header").insertAdjacentHTML("afterend",`
...
`);let e="";Ae.forEach(t=>{e+=`<button id="${t.name.toLowerCase()}">
  <span class="button_img-container">${t.img}</span>
  <span class="button_text">${t.name}</span>
  </button>`}),document.querySelector(".menu__tabs").insertAdjacentHTML("afterbegin",e),document.querySelector("#coffee").classList.add("active");let s="";me.forEach(t=>{s+=`
  <div class="card">
    <div class="card__img">
      <img
        src="${t.img}"
    ...
    <div class="card__info">
      <h3 class="heading-3 mb-3">${t.name}</h3>
      <p class="text-three-rows">${t.descriptions}</p>
      <h3 class="heading-3 mt-auto">${t.price}</h3>
    </div>
  </div>
  `}),document.querySelector(".menu__items").insertAdjacentHTML("afterbegin",s)}function Ce(){p(),ve(),A()}a===r?pe():Ce();
//# sourceMappingURL=main-d1ea7664.js.map
